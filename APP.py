...
a = st.number_input("D-index:", min_value=-10.0, max_value=100.0, value=5.0, step=0.1)
b = st.number_input("BE:", min_value=-50.0, max_value=200.0, value=50.0, step=0.1)
c = st.number_input("Kmax:", min_value=0.0, max_value=100.0, value=47.0, step=0.1)
d = st.number_input("Galectin-1:", min_value=0.0, max_value=50000.0, value=2.0, step=0.1)
e = st.number_input("Galectin-3:", min_value=0.0, max_value=50000.0, value=2.0, step=0.1)
f = st.number_input("IL-1 beta:", min_value=0.0, max_value=50000.0, value=2.0, step=0.1)
